...
The Implementation Profile for Federation Interoperability (this document) supercedes the older
link:eGovImplProfile.html[eGovernment Implementation Profile]. 
