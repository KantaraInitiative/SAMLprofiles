...
- [[[SAML-EC]]] Internet-Draft (kitten WG), SAML Enhanced Client SASL and GSS-API Mechanisms, October 10, 2015. https://datatracker.ietf.org/doc/draft-ietf-kitten-sasl-saml-ec/
