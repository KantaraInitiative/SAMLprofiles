...
This profile also addresses only behavior specific to the direct participants in the covered profiles, and does not include additional processing requirements that may be important when proxying.
